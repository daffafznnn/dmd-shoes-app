<div class="filters text-center bg-white dark:bg-darker h-auto">
    <div
        class="mx-auto flex w-full justify-center pt-6 sm:max-w-[640px] md:max-w-[768px] lg:max-w-[1024px] xl:max-w-[1280px] 2xl:max-w-[1536px] items-center">
        ...
        function filters() {
            return {
                ...
                submitFilter() {
                    ...
                    if (this.category || this.type || this.material || url.searchParams.has('search')) {
