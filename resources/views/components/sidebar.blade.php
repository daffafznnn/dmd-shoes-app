        ...
        <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
            ...
            <div x-data="{ isActive: {{ Request::is('admin/master/products') || Request::is('admin/master/products/*') ? 'true' : 'false' }}, open: false }">
                ...
                <div role="menu" x-show="open" class="mt-2 space-y-2 px-7">
                    ...
                    <div x-data="{ masterMenuOpen: false }">
                        ...
                        <div role="menu" x-show="masterMenuOpen" class="ml-4 space-y-2">
                            <a href="{{ route('master.categories.index') }}"
                                class="block p-2 text-sm text-gray-700 transition-colors duration-200 rounded-md dark:text-light dark:hover:text-light hover:text-gray-700">{{ __('Kategori') }}</a>
                            <a href="{{ route('master.units.index') }}"
                                class="block p-2 text-sm text-gray-700 transition-colors duration-200 rounded-md dark:text-light dark:hover:text-light hover:text-gray-700">{{ __('Unit') }}</a>
                            <a href="#"
                                class="block p-2 text-sm text-gray-700 transition-colors duration-200 rounded-md dark:text-light dark:hover:text-light hover:text-gray-700">{{ __('Material') }}</a>
                            <a href="#"
                                class="block p-2 text-sm text-gray-700 transition-colors duration-200 rounded-md dark:text-light dark:hover:text-light hover:text-gray-700">{{ __('Ukuran') }}</a>
                            <a href="#"
                                class="block p-2 text-sm text-gray-700 transition-colors duration-200 rounded-md dark:text-light dark:hover:text-light hover:text-gray-700">{{ __('Warna') }}</a>
                        </div>
                    </div>
