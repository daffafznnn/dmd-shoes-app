                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" class="input input-bordered w-full bg-white dark:bg-darker"
                                    placeholder="{{ __('Masukkan deskripsi produk') }}"></textarea>
                                @error('description')
                                    <span class="text-red-500">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="mt-4">
                            <fieldset class="fieldset">
                                ...
                                <input type="file" name="cover" id="cover" accept="image/*" required
                                    class="file-input" class="file-input w-full max-w-lg">
                    ...
                    <div>
                        ...
                        <div class="mt-4">
                            <fieldset class="fieldset">
                                ...
                                <label id="file-label"
                                    class="fieldset-label dark:bg-darker">{{ __('Maksimal 5 mb per gambar') }}</label>
                            </fieldset>
